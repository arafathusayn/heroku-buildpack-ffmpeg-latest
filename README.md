...
```
https://github.com/arafathusayn/heroku-buildpack-ffmpeg-latest.git
```

Or run the following from the heroku command line:

```
heroku buildpacks:add https://github.com/arafathusayn/heroku-buildpack-ffmpeg-latest.git
```
